...
import { Shield, ShieldAlert, Trash2, Loader2, Users, Activity, CheckCircle2 } from 'lucide-react'
...
function Toast({ msg, type }) {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-xl shadow-2xl text-sm font-medium animate-fade-in
      ...
      {type === 'error' ? <ShieldAlert className="w-4 h-4" /> : <CheckCircle2 className="w-4 h-4" />}
      {msg}
    </div>
  )
}
